...
#define BOARD_CELL		16		//kích thước 1 ô , nên là luỹ thừa của 2
#define BOARD_WIDTH		(BOARD_CELL * 48)	//Chìu rộng của cửa sổ
#define BOARD_HEIGHT	(BOARD_CELL * 30)	//Chìu cao của cửa sổ
